...
var parseISO = /*@__PURE__*/getDefaultExportFromCjs(parseISO_1);
...
var getMonth = /*@__PURE__*/getDefaultExportFromCjs(getMonth_1);
...
var setDay = /*@__PURE__*/getDefaultExportFromCjs(setDay_1);
...
var subYears = /*@__PURE__*/getDefaultExportFromCjs(subYears_1);
...
function createCalendarTheme(baseColor, textColor = 'inherit', emptyCellColor = tinycolor('white').darken(8).toHslString(), background = 'transparent') {
  ...
  const text = tinycolor(textColor).isValid() ? String(tinycolor(textColor)) : DEFAULT_THEME.text;
  return {
    background,
    text,
